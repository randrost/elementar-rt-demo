...
@Component({
  ...
  template: `
    <div class="flex min-h-screen bg-surface text-on-surface">
      <!-- Brand panel -->
      <div class="relative hidden w-1/2 flex-col justify-between overflow-hidden bg-primary p-12 text-on-primary lg:flex">
        <div class="flex items-center gap-2.5">
          ...
          <span class="text-lg font-semibold">Elementar<span class="opacity-70">RT</span></span>
        </div>
        ...
        <div class="flex items-center gap-3 text-sm text-on-primary/70">
